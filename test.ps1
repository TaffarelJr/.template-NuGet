...
$ReportPattern = Join-Path $TestDir "**\coverage.cobertura.xml"
...
function Show-CoverageSummary($file) {
    Write-HostInfo '───── COVERAGE SUMMARY ─────'
...
reportgenerator -reports:$ReportPattern -reporttypes:"Html;TextSummary" -targetdir:$ResultsDir
